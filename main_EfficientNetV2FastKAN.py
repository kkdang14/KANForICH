...
class CheckpointManager:
    ...
    def __init__(self, checkpoint_dir, model_name="efficientnetv2_fastkan"):
...
def main():
    ...
    checkpoint_manager = CheckpointManager(config['checkpoint_dir'], "efficientnetv2_fastkan")
    ...
    plot_path = os.path.join(config['results_dir'], 'EfficientNetV2FastKAN_training_history.png')
