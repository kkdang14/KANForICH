...
def main():
    ...
    model = EfficientNetV2FastKAN(num_classes = num_classes).to(device)
    ...
    best_model_path = r'C:\Users\HP\OneDrive\Documents\Dang\CourseFile\Luận Văn\code\model\efficientnetv2_fastkan_best_model.pth'
    ...
    plt.tight_layout()
    training_history_path = r'C:\Users\HP\OneDrive\Documents\Dang\CourseFile\Luận Văn\code\training_result\EfficientNetV2_FastKAN_training_history.png'
