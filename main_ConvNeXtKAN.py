...
class CheckpointManager:
    ...
    def __init__(self, checkpoint_dir, model_name="convnext_kan"):
...
def main():
    ...
    checkpoint_manager = CheckpointManager(config['checkpoint_dir'], "convnext_kan")
    ...
    plot_path = os.path.join(config['results_dir'], 'ConvNeXtKAN_training_history.png')
