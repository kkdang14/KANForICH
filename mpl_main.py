...
from MLP.BasicCNNMLP import BasicCNNMLP
from MLP.ResNetMLP import ResNetMLP 
from MLP.ConvNeXtMLP import ConvNeXtMLP
from MLP.DenseNetMLP import DenseNetMLP
from MLP.EfficientNetV2MLP import EfficientNetV2MLP 
...
def get_model_registry():
    ...
    return {
        ...
        'basic_cnn_mlp': BasicCNNMLP,
        'convnext_mlp': ConvNeXtMLP,
        'densenet_mlp': DenseNetMLP,
        'efficientnetv2_mlp': EfficientNetV2MLP
    }
...
def main():
    ...
    config = {
        ...
        'checkpoint_dir': r'C:\Users\HP\Documents\Dang\CourseFile\Luận Văn\code\mlp_checkpoints',
        'results_dir': r'C:\Users\HP\Documents\Dang\CourseFile\Luận Văn\code\mlp_training_result',
        'models': [
            {'name': 'resnet_kan', 'class': ResNetMLP},
            {'name': 'basic_cnn_kan', 'class': BasicCNNMLP},
            {'name': 'convnext_kan', 'class': ConvNeXtMLP},
            {'name': 'densenet_kan', 'class': DenseNetMLP},
            {'name': 'efficientnetv2_kan', 'class': EfficientNetV2MLP}
        ]
    }
