...
class SimpleImageEvaluator:
    ...
    def load_model(self):
        """Load trained model"""
        self.model = EfficientNetV2KAN().to(self.device)
...
def main():
    evaluator = SimpleImageEvaluator(
        model_path=r"C:\Users\HP\OneDrive\Documents\Dang\CourseFile\Luận Văn\code\model\efficientnetv2_kan_best_model.pth",
        data_dir=r"C:\Users\HP\OneDrive\Documents\Dang\CourseFile\Luận Văn\code\data\test",
        output_dir=r"C:\Users\HP\OneDrive\Documents\Dang\CourseFile\Luận Văn\code\test\efficientnetv2_kan_evaluation_results",
