...
def main():
    ...
    best_model_path = r'C:\Users\HP\OneDrive\Documents\Dang\CourseFile\Luận Văn\code\model\efficientnetv2_kan_best_model.pth'
    ...
    plt.tight_layout()
    training_history_path = r'C:\Users\HP\OneDrive\Documents\Dang\CourseFile\Luận Văn\code\training_result\EfficientNetV2_KAN_training_history.png'
