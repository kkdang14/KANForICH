...
class CheckpointManager:
    ...
    def __init__(self, checkpoint_dir, model_name="densenet_kan"):
...
def main():
    ...
    checkpoint_manager = CheckpointManager(config['checkpoint_dir'], "densenet_kan")
    ...
    plot_path = os.path.join(config['results_dir'], 'DenseNetKAN_training_history.png')
