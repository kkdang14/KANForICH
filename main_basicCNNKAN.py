...
class CheckpointManager:
    ...
    def __init__(self, checkpoint_dir, model_name="basiccnn_kan"):
...
def main():
    ...
    checkpoint_manager = CheckpointManager(config['checkpoint_dir'], "basiccnn_kan")
    ...
    plot_path = os.path.join(config['results_dir'], 'BasicCNNKAN_training_history.png')
