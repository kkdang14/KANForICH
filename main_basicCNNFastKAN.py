...
def main():
    ...
    model = BasicCNNFastKAN(num_classes=11).to(device)
    ...
    best_model_path = r'C:\Users\HP\OneDrive\Documents\Dang\CourseFile\Luận Văn\code\model\cnn_fastkan_best_model.pth'
    ...
    plt.tight_layout()
    training_history_path = r'C:\Users\HP\OneDrive\Documents\Dang\CourseFile\Luận Văn\code\training_result\CNN_FastKAN_training_history.png'
