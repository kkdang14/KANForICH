...
def train(model, train_loader, criterion, optimizer, device, epoch, config):
    ...
    print(f"\rEpoch {epoch+1}/{num_epochs} - Train Loss: {epoch_loss:.4f}, Train Acc: {epoch_acc:.4f} - Progress: [{epoch_progress:.1f}%]")
...
def main():
    ...
    config = {
        ...
        'checkpoint_dir': r'C:\Users\HP\Documents\Dang\CourseFile\Luận Văn\code\fastkan_checkpoints',
        'results_dir': r'C:\Users\HP\Documents\Dang\CourseFile\Luận Văn\code\fastkan_training_result',
        'models': [
