...
class CheckpointManager:
    ...
    def __init__(self, checkpoint_dir, model_name="convnext_fastkan"):
...
def main():
    ...
    checkpoint_manager = CheckpointManager(config['checkpoint_dir'], "convnext_fastkan")
    ...
    plot_path = os.path.join(config['results_dir'], 'ConvNeXtFastKAN_training_history.png')
