...
class EfficientNetV2MLP(nn.Module):
    def __init__(self, num_classes=10):
        super(EfficientNetV2MLP, self).__init__()
        
        # Use EfficientNetV2-S backbone from torchvision
        ...
        self.fc1 = nn.Linear(1280, 128)  # EfficientNetV2-S outputs 1280 features
    ...
    def forward(self, x):
        ...
        x = x.view(x.size(0), -1)  # Flatten: [batch_size, 1280]
...
model = EfficientNetV2MLP(num_classes=10).to(device)
