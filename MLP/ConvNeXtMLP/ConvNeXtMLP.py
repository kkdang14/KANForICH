...
class ConvNeXtMLP(nn.Module):
    def __init__(self, num_classes=10):
        super(ConvNeXtMLP, self).__init__()
        
        # Use ConvNeXt-Tiny backbone from torchvision
        convnext = convnext_tiny(pretrained=False)
        ...
        self.fc1 = nn.Linear(768, 128)  # ConvNeXt-Tiny outputs 768 features
    ...
    def forward(self, x):
        ...
        x = x.view(x.size(0), -1)  # Flatten: [batch_size, 768]
...
model = ConvNeXtMLP(num_classes=10).to(device)
